...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "1BW8G8m83LkbOm6YIR2txn5MT", consumerSecret: "AMnVaXTk2pFcFaTqhYt9anhALGkDbraYBF2NKAP6GRLxM3WgZ8")
    var loginSuccess: (() -> ())?
